...
maps[0].set('0', 1); // Bronze 1
maps[0].set('1', 2); // Bronze 2
maps[0].set('2', 2); // Bronze 3
maps[0].set('3', 3); // Silver 1
maps[0].set('4', 3); // Silver 2
maps[0].set('5', 5); // Silver 3
maps[0].set('6', 5); // Gold 1
maps[0].set('7', 5); // Gold 2
maps[0].set('8', 5); // Gold 3
maps[0].set('9', 10); // Plat 1
maps[0].set('10', 10); // Plat 2
maps[0].set('11', 10); // Plat 3
maps[0].set('12', 15); // Diamond 1
maps[0].set('13', 15); // Diamond 2
maps[0].set('14', 20); // Diamond 3
maps[0].set('15', 25); // Champ 1
maps[0].set('16', 25); // Champ 2
maps[0].set('17', 30); // Champ 3
maps[0].set('18', 40); // GC 1
maps[0].set('19', 50); // GC 2
maps[0].set('20', 60); // GC 3
maps[0].set('21', 90); // SSL
